...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Formations FEGK - Catalogue Complet",
    description:
      "Découvrez notre catalogue de formations continues en Management et Audit Qualité",
    url: "https://managementauditetqualite.com/formations",
  ...
  twitter: {
    ...
    title: "Formations FEGK - Catalogue Complet",
    description: "Découvrez notre catalogue de formations continues",
    images: ["/LOGO.jpg"],
  },
  alternates: {
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-8">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
              Découvrez nos programmes spécialisés en Management et Marketing
              des Services, conçus pour les professionnels ambitieux
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Deux niveaux de formation pour répondre à vos ambitions
              professionnelles
            </p>
          </div>
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 p-8">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <Badge
                      variant="outline"
                      className="border-white text-white bg-white/20 font-semibold"
                    >
                      Niveau Bac+2
                    </Badge>
                  </div>
                  ...
                  <p className="text-blue-100 text-lg leading-relaxed">
                    Maîtrisez la conception et la production d'offres de
                    services compétitives adaptées aux besoins clients
                  </p>
                </div>
              ...
              <CardContent className="p-8">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700">
                        Double compétence Management & Marketing
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0" />
                      <span className="text-gray-700">
                        Approche pratique avec études de cas
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0" />
                      <span className="text-gray-700">
                        Projet de fin d'études professionnel
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-8 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-blue-800 text-sm leading-relaxed">
                    Responsable marketing, Chef de projet innovation, Directeur
                    d'établissement hôtelier, Responsable clientèle, Chargé
                    d'études marketing
                  </p>
                </div>
            ...
            <Card className="border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden group">
              <div className="relative">
                <div className="bg-gradient-to-br from-green-600 via-green-700 to-emerald-800 p-8">
                  <div className="flex justify-between items-start mb-6">
                    <Badge className="bg-white text-green-700 font-semibold px-3 py-1">
                      Master Spécialisé
                    </Badge>
                    <Badge
                      variant="outline"
                  ...
                  <p className="text-green-100 text-lg leading-relaxed">
                    Formation avancée pour les cadres du middle et top
                    management dans le secteur des services
                  </p>
                </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0" />
                      <span className="text-gray-700">
                        Formation de cadres supérieurs poly-compétents
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0" />
                ...
                <div className="mb-8 p-4 bg-green-50 rounded-lg">
                  ...
                  <p className="text-green-800 text-sm leading-relaxed">
                    Marketing stratégique, Management international, Chargé de
                    veille innovation, Consultant en stratégie, Directeur
                    général, Entrepreneur
                  </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Trouvez la formation qui correspond à votre profil
            </p>
          </div>
