        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Les détails complets de ce programme de Master seront bientôt disponibles. Cette formation avancée en
              Audit et Qualité est actuellement en cours de finalisation.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              <Image
                src="/placeholder.svg?height=400&width=600&text=Master+Audit+Qualité"
                alt="Master Audit et Qualité"
                width={600}
                height={400}
