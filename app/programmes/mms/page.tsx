...
import { Clock, Euro, Calendar, FileText, CheckCircle, Users, Target, BookOpen } from "lucide-react"
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 sm:py-16 px-4">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <Card className="border-blue-200">
                <CardHeader className="bg-blue-50">
                  ...
                  <CardTitle className="text-blue-800">Approfondissement</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
          ...
          {/* Career Prospects */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center text-blue-800">Débouchés de la Formation</h2>
            <div className="bg-blue-50 rounded-lg p-8">
              <p className="text-gray-700 mb-6">
                La licence MMS forme des cadres travaillant à la conception, à la commercialisation et à la production
                des services au sein des départements commercial, marketing ou innovation des entreprises de services ou
                des entreprises industrielles proposant une offre de services associée à leurs produits.
              </p>

              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="text-center">
                  <Target className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                  <h3 className="font-semibold mb-2 text-blue-800">Marketing & Commercial</h3>
                  <p className="text-sm text-gray-600">
                    Chargé d'études, Responsable marketing stratégique, Responsable produit
                  </p>
                </div>

                <div className="text-center">
                  <Users className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                  <h3 className="font-semibold mb-2 text-blue-800">Management</h3>
                  <p className="text-sm text-gray-600">
                    Responsable clientèle, Chef de projet innovation de services, Chef de projet expérience client
                  </p>
                </div>

                <div className="text-center">
                  <BookOpen className="h-8 w-8 text-blue-600 mx-auto mb-2" />
                  <h3 className="font-semibold mb-2 text-blue-800">Secteur Hôtelier & Tourisme</h3>
                  <p className="text-sm text-gray-600">
                    Directeurs ou gérants d'établissement hôtelier, de tourisme et des organisations de services
                  </p>
                </div>
              </div>
            </div>
              ...
              <Card className="border-blue-200">
                ...
                <CardContent>
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5" />
                      <span>Titulaires d'un Bac + 2 public ou privé (Accrédité)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5" />
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="text-center border-blue-200">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-blue-600 mb-2">16 000 DH</div>
              ...
              <Card className="text-center border-blue-200">
                ...
                <CardContent>
                  <div className="text-lg font-bold text-blue-600 mb-2">2 Tranches</div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Effectuez votre pré-inscription en ligne ou contactez directement le responsable de la formation.
            </p>
